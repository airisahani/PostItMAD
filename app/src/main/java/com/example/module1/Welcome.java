...
public class Welcome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvWelcomeMessage = view.findViewById(R.id.welcomeMessage);

        // Retrieve the username passed from the SignUp fragment
        ...
        // Use NavController to navigate to UserProfile
        ...
        btnContinue.setOnClickListener(OCL3);
